export const CORPUS_FILES: Record<string, string> = {
  ...
  return (
    <div className="@flex-row @flex-center @stack-md p-6">
  ...
  return (
    <div className="@card @card-interactive max-w-sm">
      <div className="@card-header">
        <h3 className="@h3">Premium Product</h3>
      ...
      <div className="@card-body">
        ...
        <div className="@flex-row @flex-center justify-between mt-4">
          <span className="text-2xl font-bold">$99.99</span>
          <span className="@muted-text">Save 20%</span>
        </div>
      </div>
  ...
  return (
    <div className="@card max-w-md mx-auto p-8">
      <h2 className="@h2 mb-6 text-center">Welcome Back</h2>
      <form className="@flex-col @stack-md">
        <div className="@form-group">
          <label className="@form-label" htmlFor="email">Email Address</label>
          <input className="@form-input" id="email" type="email" placeholder="you@example.com" required />
          <span className="@form-helper">We will never share your email.</span>
        </div>
        <div className="@form-group">
  ...
  return (
    <div className="@sidebar-layout min-h-screen bg-background">
      <aside className="@flex-col @stack-md w-64 border-r border-border bg-card p-4">
        <div className="flex h-12 items-center px-2 font-bold text-lg">
          Shortwind Console
        </div>
        <nav className="@flex-col @stack-xs">
          <a className="@link-text bg-accent text-accent-foreground px-3 py-2 rounded-md font-medium" href="/dashboard">Dashboard</a>
          <a className="@link-text text-muted-foreground px-3 py-2 rounded-md hover:text-foreground" href="/analytics">Analytics</a>
          <a className="@link-text text-muted-foreground px-3 py-2 rounded-md hover:text-foreground" href="/settings">Settings</a>
        </nav>
      </aside>
      <div className="@flex-col flex-1">
        ...
        <main className="@container-lg @flex-col @stack-lg py-8">
